...
public class IdiomaController {
	...
	@PostMapping("/agregar")
	public String AgregarId(@RequestBody Idioma i) {
	...
	public String EditarId(@RequestBody Idioma i, @PathVariable int id, Model model) {
	...
	public String EliminarId(@PathVariable int id, Model model) {
